      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block "><img src="<?php echo base_url() . 'assets/img/sandals.png'; ?> " class="card-img-top"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-right"> <a class="small" href="<?php echo base_url('welcome'); ?>">X</a></div>
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Login User SANDALIN!</h1>
                  </div>
